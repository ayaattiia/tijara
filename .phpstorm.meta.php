...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\workspace\tijara-api\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\workspace\\tijara-api\\public\\storage','logging.default','logging.deprecations.channel',
...
'mail.markdown.extensions','passport.guard','passport.middleware','passport.private_key','passport.public_key',
'passport.connection','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'passport.authorizations.approve','passport.authorizations.deny','passport.device.authorizations.authorize','passport.device.authorizations.approve','passport.device.authorizations.deny','ad-comments.index','ad-comments.store','ad-comments.show','ad-comments.update',
'ad-comments.destroy','ad-likes.index','ad-likes.store','ad-likes.show','ad-likes.update',
'ad-likes.destroy','admin-settings.index','admin-settings.store','admin-settings.show','admin-settings.update',
'admin-settings.destroy','ads-wishlist.index','ads-wishlist.store','ads-wishlist.show','ads-wishlist.update',
'ads-wishlist.destroy','boost-ads-packs.index','boost-ads-packs.store','boost-ads-packs.show','boost-ads-packs.update',
'boost-ads-packs.destroy','boosts.index','boosts.store','boosts.show','boosts.update',
'boosts.destroy','brands.index','brands.store','brands.show','brands.update',
'brands.destroy','categories.index','categories.store',
'categories.show','categories.update','categories.destroy','causes.index','causes.store',
'causes.show','causes.update','causes.destroy','causes-reports.index','causes-reports.store',
'causes-reports.show','causes-reports.update','causes-reports.destroy','chat-messages.index','chat-messages.store',
'chat-messages.show','chat-messages.update','chat-messages.destroy','chats.index','chats.store',
'chats.show','chats.update','chats.destroy','cities.index','cities.store',
'cities.show','cities.update','cities.destroy','comments.index','comments.store',
'comments.show','comments.update','comments.destroy','countries.index','countries.store',
'countries.show','countries.update','countries.destroy','countries-full.index','countries-full.store',
'countries-full.show','countries-full.update','countries-full.destroy','coupons.index','coupons.store',
'coupons.show','coupons.update','coupons.destroy','deals.index','deals.store',
'deals.show','deals.update','deals.destroy','deals-wishlist.index','deals-wishlist.store',
'deals-wishlist.show','deals-wishlist.update','deals-wishlist.destroy','deliveries.index','deliveries.store',
'deliveries.show','deliveries.update','deliveries.destroy','email-tokens.index','email-tokens.store',
'email-tokens.show','email-tokens.update','email-tokens.destroy','errors.index','errors.store',
'errors.show','errors.update','errors.destroy','feature-categories.index','feature-categories.store',
'feature-categories.show','feature-categories.update','feature-categories.destroy','features.index','features.store',
'features.show','features.update','features.destroy','features-values.index','features-values.store',
'features-values.show','features-values.update','features-values.destroy','invoices.index','invoices.store',
'invoices.show','invoices.update','invoices.destroy','labels.index','labels.store',
'labels.show','labels.update','labels.destroy','likes.index','likes.store',
'likes.show','likes.update','likes.destroy','list-permissions.index','list-permissions.store',
'list-permissions.show','list-permissions.update','list-permissions.destroy','messages.index','messages.store',
'messages.show','messages.update','messages.destroy','notifications.index','notifications.store',
'notifications.show','notifications.update','notifications.destroy','order-details.index','order-details.store',
'order-details.show','order-details.update','order-details.destroy','orders.index','orders.store',
'orders.show','orders.update','orders.destroy','payments.index','payments.store',
'payments.show','payments.update','payments.destroy','permissions.index','permissions.store',
'permissions.show','permissions.update','permissions.destroy','point-packets.index','point-packets.store',
'point-packets.show','point-packets.update','point-packets.destroy','prizes.index','prizes.store',
'prizes.show','prizes.update','prizes.destroy',
'products.show','products.update','products.destroy','product-wishlist.index','product-wishlist.store',
'product-wishlist.show','product-wishlist.update','product-wishlist.destroy','ratings.index','ratings.store',
'ratings.show','ratings.update','ratings.destroy','reports.index','reports.store',
'reports.show','reports.update','reports.destroy','reviews.index','reviews.store',
'reviews.show','reviews.update','reviews.destroy','roles.index','roles.store',
'roles.show','roles.update','roles.destroy','sms-logs.index','sms-logs.store',
'sms-logs.show','sms-logs.update','sms-logs.destroy','states.index','states.store',
'states.show','states.update','states.destroy','tags.index','tags.store',
'tags.show','tags.update','tags.destroy','transports.index','transports.store',
'transports.show','transports.update','transports.destroy','type-category.index','type-category.store',
'type-category.show','type-category.update','type-category.destroy','user-follows.index','user-follows.store',
'user-follows.show','user-follows.update','user-follows.destroy','users.index','users.store',
'users.show','users.update','users.destroy','wallets.index','wallets.store',
'wallets.show','wallets.update','wallets.destroy','winners.index','winners.store',
'winners.show','winners.update','winners.destroy','wishlist-ads.index','wishlist-ads.store',
'wishlist-ads.show','wishlist-ads.update','wishlist-ads.destroy','wishlist-deals.index','wishlist-deals.store',
'wishlist-deals.show','wishlist-deals.update','wishlist-deals.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'emails.reset-password','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.workspace.tijara-api.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_PORT','DB_DATABASE','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',

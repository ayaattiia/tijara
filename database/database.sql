...
ALTER TABLE Users
ADD COLUMN RecentlyViewed JSON NULL,
ADD COLUMN LastViewedAt TIMESTAMP NULL DEFAULT NULL,
ADD COLUMN ViewCount INT(11) DEFAULT 0;
...
ALTER TABLE Products
ADD COLUMN IdBrand BIGINT UNSIGNED NULL;
